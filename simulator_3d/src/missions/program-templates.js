export function buildProgram(profile, headingDeg) {
    ...
    if (profile.programTemplate === "voyager-2-grand-tour") {
      ...
      return [
        ...
        correctionBurn("Voyager TCM: mid Jupiter→Saturn cruise", 90000000, 8 * 3600, 0.0004, "Saturn", flybys.saturn, 101000, [0.82, -0.46, 0.34]),
        ...
        correctionBurn("Voyager TCM: mid Saturn→Uranus cruise", 196000000, 8 * 3600, 0.0004, "Uranus", flybys.uranus, 81500, [-0.22, -0.73, 0.65]),
        ...
        correctionBurn("Voyager TCM: mid Uranus→Neptune cruise", 310000000, 8 * 3600, 0.0003, "Neptune", flybys.neptune, 4800, [0.54, 0.58, -0.61]),
